    ...
    <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow-sm">
        ...
        <div class="p-4">
            <div class="flex flex-row justify-between">
                ...
                <!-- File menu -->
                <div id="fileDropdownDivider" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
            ...
            <p class="font-normal text-xs text-gray-700">0 MB</p>
        </div>
    </div>
