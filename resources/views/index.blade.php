...
@section('content')
    <div class="flex flex-row gap-5 justify-center items-center w-full h-screen max-sm:px-5 ">
        <form method="POST" action="{{ route('account.login') }}" class="mx-auto w-full md:w-[320px]">
            ...
            <button
                type="submit"
                class="mb-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center"
            >
                Login
            </button>
